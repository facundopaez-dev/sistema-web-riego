...
public enum SourceUnsatisfiedResponse {
  ...
  NON_EXISTENT_DATA_FOR_THE_GENERATION_OF_STATISTICAL_REPORTS("ORIGIN_NON_EXISTENT_DATA_FOR_THE_GENERATION_OF_STATISTICAL_REPORTS"),
  NON_EXISTENT_DATA_FOR_THE_REGENERATION_OF_STATISTICAL_REPORTS("ORIGIN_NON_EXISTENT_DATA_FOR_THE_REGENERATION_OF_STATISTICAL_REPORTS");
