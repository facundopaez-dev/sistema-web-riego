...
/**
 * La clase ClassPenmanMonteithEtoTest es UNICAMENTE para demostrar
 * que el metodo calculateEto de la clase PenmanMonteithEto calcula
 * correctamente la evapotranspiracion del cultivo de referencia (ETo).
 * 
 * Esta clase tiene el metodo calculateEto de la clase PenmanMonteithEto
 * con la unica diferencia de que en este clase tiene dos parametros
 * mas: es (presion media de vapor de la saturacion) y ea (presion
 * real de vapor).
 * 
 * Esto se hace para evitar el harcode de las variables es (presion
 * media de vapor de la saturacion) y ea (presion real de vapor) en
 * el metodo calculateEto de la clase PenmanMonteithEto. Este harcode
 * se debe hacer cada vez que se quiere demostrar que dicho metodo
 * calcula correctamente la evpotranspiracion del cultivo de
 * referencia (ETo).
 */
public class ClassPenmanMonteithEtoTest {
  ...
  public static double calculateEto(double minTemperature, double maxTemperature, double pressure, double windSpeed,
      double extraterrestrialSolarRadiation, double maximumInsolation, double actualDurationSunstroke,
      double meanSaturationVaporPressure, double realVaporPressure) {
    ...
    double vaporPressureDeficit = meanSaturationVaporPressure - realVaporPressure;

    // Radiacion neta (Rn) [MJ/metro cuadrado * dia]
    double rn = netRadiation(extraterrestrialSolarRadiation, realVaporPressure, minTemperature, maxTemperature,
        maximumInsolation,
