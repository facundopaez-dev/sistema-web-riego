...
public class SoilServiceBean {
    ...
    public Page<Soil> findAllPagination(Integer page, Integer cantPerPage, Map<String, String> parameters) {
        ...
        Query countQuery = entityManager
                .createQuery("SELECT COUNT(u.id) FROM " + Soil.class.getSimpleName() + " u" + where.toString());

        // Realiza la paginacion
        Query query = entityManager.createQuery("FROM " + Soil.class.getSimpleName() + " u" + where.toString());
        ...
        // Arma la respuesta
        Page<Soil> resultPage = new Page<Soil>(page, count, page > 1 ? page - 1 : page,
