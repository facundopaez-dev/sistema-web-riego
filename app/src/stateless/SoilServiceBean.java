...
public class SoilServiceBean {
    ...
    public Page<Soil> findAllPagination(Integer page, Integer cantPerPage, Map<String, String> parameters) {
        ...
        if (parameters != null) {
            ...
            for (String param : parameters.keySet()) {
                ...
                try {
                    method = Soil.class.getMethod("get" + capitalize(param));
        ...
        Query countQuery = entityManager.createQuery("SELECT COUNT(e.id) FROM " + Soil.class.getSimpleName() + " e" + where.toString());

        // Pagina
        Query query = entityManager.createQuery("FROM " + Soil.class.getSimpleName() + " e" + where.toString());
        ...
        // Arma la respuesta
        Page<Soil> resultPage = new Page<Soil>(page, count, page > 1 ? page - 1 : page, page < lastPage ? page + 1 : lastPage, lastPage, query.getResultList());
        return resultPage;
    }
