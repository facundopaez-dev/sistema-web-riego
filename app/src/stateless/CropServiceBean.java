...
public class CropServiceBean {
  ...
  public Page<Crop> findAllPagination(Integer page, Integer cantPerPage, Map<String, String> parameters) {
    ...
    Query countQuery = entityManager
        .createQuery("SELECT COUNT(u.id) FROM " + Crop.class.getSimpleName() + " u" + where.toString());

    // Realiza la paginacion
    Query query = entityManager.createQuery("FROM " + Crop.class.getSimpleName() + " u" + where.toString());
