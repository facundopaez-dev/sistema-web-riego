...
public class CropServiceBean {
  ...
  public Page<Crop> findAllPagination(Integer page, Integer cantPerPage, Map<String, String> parameters) {
    ...
    Query countQuery = entityManager.createQuery("SELECT COUNT(e.id) FROM " + Crop.class.getSimpleName() + " e" + where.toString());

    // Pagina
    Query query = entityManager.createQuery("FROM " + Crop.class.getSimpleName() + " e" + where.toString());
    ...
    // Arma la respuesta
    Page<Crop> resultPage = new Page<Crop>(page, count, page > 1 ? page - 1 : page, page < lastPage ? page + 1 : lastPage, lastPage, query.getResultList());
    return resultPage;
  }
