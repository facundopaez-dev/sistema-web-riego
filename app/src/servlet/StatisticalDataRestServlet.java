...
public class StatisticalDataRestServlet {

  @EJB StatisticalDataServiceBean statisticalDataService;
  ...
  public Response findAll(@Context HttpHeaders request) throws IOException {
     ...
     * por el cliente
     */
    return Response.status(Response.Status.OK).entity(mapper.writeValueAsString(statisticalDataService.findAll())).build();
  }
