...
public class StatisticalReportRestServlet {
  ...
  public Response findAllPagination(@Context HttpHeaders request, @QueryParam("page") Integer page, @QueryParam("cant") Integer cant) throws IOException {
       ...
       * por el cliente
       */
      Page<StatisticalReport> statisticalReports = statisticalReportService.findAllPagination(userId, page, cant, null);
      return Response.status(Response.Status.OK).entity(mapper.writeValueAsString(statisticalReports)).build();
  }
