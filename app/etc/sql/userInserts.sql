...
INSERT INTO IRRIGATION_SYSTEM_USER (USERNAME, NAME, LAST_NAME, ACTIVE, SUPERUSER, SUPERUSER_PERMISSION_MODIFIER)
VALUES ('admin', 'Admin name', 'Admin last name', 1, 1, 1);
