app.controller(
	"PastDaysReferencesCtrl",
	["$scope", "$location", "PastDaysReferenceSrv", "AccessManager", "ErrorResponseManager", "AuthHeaderManager", "LogoutManager",
		function ($scope, $location, pastDaysReferenceSrv, accessManager, errorResponseManager, authHeaderManager, logoutManager) {

			console.log("Cargando PastDaysReferencesCtrl...")
			...
			*/
			...
			function findAll() {
				pastDaysReferenceSrv.findAll(function (error, data) {
					if (error) {
