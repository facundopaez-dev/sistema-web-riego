  ...
  ["$scope", "$location", "$routeParams", "CropSrv", "TypeCropSrv", "RegionSrv", "MonthSrv", "AccessManager", "ErrorResponseManager", "AuthHeaderManager", "LogoutManager",
    ...
    function ($scope, $location, $params, cropService, typeCropService, regionService, monthService, accessManager, errorResponseManager, authHeaderManager, logoutManager,
      ...
      */
      ...
      const UNDEFINED_INITIAL_KC = "El coeficiente inicial de cultivo (Kc inicial) debe estar definido";
      const UNDEFINED_MIDDLE_KC = "El coeficiente medio de cultivo (Kc medio) debe estar definido";
      const UNDEFINED_FINAL_KC = "El coeficiente final de cultivo (Kc final) debe estar definido";
      const INVALID_INITIAL_KC = "El coeficiente inicial de cultivo (Kc inicial) debe ser mayor a 0.0";
      const INVALID_MIDDLE_KC = "El coeficiente medio de cultivo (Kc medio) debe ser mayor a 0.0";
      const INVALID_FINAL_KC = "El coeficiente final de cultivo (Kc final) debe ser mayor a 0.0";
